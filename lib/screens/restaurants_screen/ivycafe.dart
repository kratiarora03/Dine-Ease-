...
class IvyRestaurantScreen extends StatelessWidget {
  final Restaurant restaurant; // Pass the Restaurant object to the screen

  const IvyRestaurantScreen({Key? key, required this.restaurant})
      : super(key: key);
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('images/ivy1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        Image.asset('images/ivymenu.jpg'),
                        const SizedBox(
                          height: 16,
                        ),
                        Image.asset('images/ivymenu1.jpg'),
                        const SizedBox(height: 16),
                        Image.asset('images/ivymenu2.jpg'),
                        const SizedBox(height: 16),
                      ],
                    ),
                  ],
