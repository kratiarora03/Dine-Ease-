...
import 'package:fooddelivery/pages/map_page.dart';
...
class GuftaguRestaurantScreen extends StatelessWidget {
  final Restaurant restaurant; // Pass the Restaurant object to the screen

  const GuftaguRestaurantScreen({Key? key, required this.restaurant})
      : super(key: key);
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('images/guftagu1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'The First Poetry Cafe of India',
                    ...
                    Column(
                      children: [
                        Image.asset('images/guftagumenu.jpg'),
                        const SizedBox(
                          height: 16,
                        ),
                        Image.asset('images/guftagumenu1.jpg'),
                        const SizedBox(height: 16),
                        Image.asset('images/guftagumenu2.jpg'),
                        const SizedBox(height: 16),
