...
class LatestRestaurantScreen extends StatelessWidget {
  final Restaurant restaurant; // Pass the Restaurant object to the screen

  const LatestRestaurantScreen({Key? key, required this.restaurant})
      : super(key: key);
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('images/latest1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        Image.asset('images/latestmenu.jpg'),
                        const SizedBox(
                          height: 16,
                        ),
                        Image.asset('images/latestmenu1.jpg'),
                        const SizedBox(height: 16),
                        Image.asset('images/latestmenu2.jpg'),
                        const SizedBox(height: 16),
