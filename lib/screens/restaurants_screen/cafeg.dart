...
class CafegRestaurantScreen extends StatelessWidget {
  final Restaurant restaurant; // Pass the Restaurant object to the screen

  const CafegRestaurantScreen({Key? key, required this.restaurant})
      : super(key: key);
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('images/cafeg1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        Image.asset('images/cafegmenu.jpg'),
                        const SizedBox(
                          height: 16,
                        ),
                        Image.asset('images/cafegmenu1.jpg'),
                        const SizedBox(height: 16),
                        // Image.asset('images/menu_item3.jpg'),
                        // const SizedBox(height: 16),
