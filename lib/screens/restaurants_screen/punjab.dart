...
class PunjabRestaurantScreen extends StatelessWidget {
  final Restaurant restaurant; // Pass the Restaurant object to the screen

  const PunjabRestaurantScreen({Key? key, required this.restaurant})
      : super(key: key);
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('images/punjab1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        Image.asset('images/punjabmenu.jpg'),
                        const SizedBox(
                          height: 16,
                        ),
                        Image.asset('images/punjabmenu1.jpg'),
                        const SizedBox(height: 16),
