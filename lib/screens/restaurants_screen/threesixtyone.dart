...
class ThreesixtyRestaurantScreen extends StatelessWidget {
  final Restaurant restaurant; // Pass the Restaurant object to the screen

  const ThreesixtyRestaurantScreen({Key? key, required this.restaurant})
      : super(key: key);
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('images/361cafe1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        Image.asset('images/361cafemenu.jpg'),
                        const SizedBox(
                          height: 16,
                        ),
                        Image.asset('images/361cafemenu1.jpg'),
                        const SizedBox(
                          height: 16,
                        ),
                        Image.asset('images/361cafemenu2.jpg'),
                        const SizedBox(
                          height: 16,
                        )
