...
class KitchenRestaurantScreen extends StatelessWidget {
  final Restaurant restaurant; // Pass the Restaurant object to the screen

  const KitchenRestaurantScreen({Key? key, required this.restaurant})
      : super(key: key);
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('images/kitchen1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        Image.asset('images/kitchenmenu.jpg'),
                        const SizedBox(
                          height: 16,
                        ),
                        Image.asset('images/kitchenmenu1.jpg'),
                        const SizedBox(height: 16),
                        Image.asset('images/kitchenmenu2.jpg'),
                        const SizedBox(height: 16),
